...
static int
xer__token_cb(pxml_chunk_type_e type, const void *_chunk_data,
 ...
 */
ssize_t
xer_next_token(int *stateContext, const void *buffer, size_t size,
...
xer_decode_general(const asn_codec_ctx_t *opt_codec_ctx,
                   ...
                   int (*opt_unexpected_tag_decoder)(void *struct_key,
                                                     const void *chunk_buf,
                                                     size_t chunk_size),
                   ssize_t (*body_receiver)(void *struct_key,
                                            const void *chunk_buf,
