...
#include <oer_encoder.h>	/* Packet Encoding Rules encoder */
#include <oer_decoder.h>	/* Packet Encoding Rules encoder */
...
typedef struct asn_TYPE_descriptor_s {
	...
	oer_type_decoder_f *oer_decoder;	/* Canonical OER decoder */
