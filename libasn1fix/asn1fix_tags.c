...
static int
asn1f_fetch_tags_impl(arg_t *arg, struct asn1p_type_tag_s **tags, int count,
                      int skip, enum asn1f_aft_flags_e flags) {
...
static int
asn1f_fetch_minimal_choice_root_tag(arg_t *arg, struct asn1p_type_tag_s *tag,
                                    enum asn1f_aft_flags_e flags) {
...
int
asn1f_fetch_outmost_tag(asn1p_t *asn, asn1_namespace_t *ns, asn1p_module_t *mod,
                        asn1p_expr_t *expr, struct asn1p_type_tag_s *tag,
                        enum asn1f_aft_flags_e flags) {
...
int
asn1f_fetch_tags(asn1p_t *asn, asn1_namespace_t *ns, asn1p_module_t *mod,
