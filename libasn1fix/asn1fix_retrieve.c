...
asn1p_module_t *
asn1f_lookup_module(arg_t *arg, const char *module_name,
...
asn1f_lookup_symbol_impl(arg_t *arg, asn1p_expr_t *rhs_pspecs,
                         const asn1p_ref_t *ref, int recursion_depth) {
...
asn1f_find_terminal_thing(arg_t *arg, asn1p_expr_t *expr, enum ftt_what what) {
    ...
    case FTT_VALUE:
        ...
        DEBUG("%s(%s->%s) meta %d for line %d", "VALUE", expr->Identifier,
              asn1f_printable_reference(ref), expr->meta_type, expr->_lineno);
 ...
 */
static int
asn1f_compatible_with_exports(arg_t *arg, asn1p_module_t *mod,
                              const char *name) {
