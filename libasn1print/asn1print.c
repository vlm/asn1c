...
static size_t
safe_fwrite(const void *ptr, size_t size) {
    size_t ret;
...
static int
asn1print_module(asn1p_t *asn, asn1p_module_t *mod,
                 enum asn1print_flags flags) {
    asn1p_expr_t *tc;
...
asn1print_value(const asn1p_value_t *val, enum asn1print_flags flags) {
    ...
    case ATV_TYPE:
        asn1print_expr(val->value.v_type->module->asn1p,
                       val->value.v_type->module, val->value.v_type, flags, 0);
        return 0;
    case ATV_INTEGER:
...
static int
asn1print_constraint_explain_type(const char *dbg_name,
...
static int
asn1print_expr(asn1p_t *asn, asn1p_module_t *mod, asn1p_expr_t *tc,
               enum asn1print_flags flags, int level) {
    int SEQ_OF = 0;
    int has_space = 0;
...
static int
asn1print_expr_dtd(asn1p_t *asn, asn1p_module_t *mod, asn1p_expr_t *expr,
                   enum asn1print_flags flags, int level) {
    asn1p_expr_t *se;
