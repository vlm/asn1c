...
static int asn1print_expr_proto(asn1p_t *asn, asn1p_module_t *mod, asn1p_expr_t *tc, enum asn1print_flags flags, int level);
...
asn1print(asn1p_t *asn, enum asn1print_flags flags) {
	...
	if(flags & APF_PRINT_XML_DTD) {
		...
		safe_printf("# Protobuf generated by asn1c-" VERSION " -->\n");
	}
...
asn1print_module(asn1p_t *asn, asn1p_module_t *mod, enum asn1print_flags flags) {
	...
	if(flags & APF_PRINT_XML_DTD) {
		...
		if(mod->source_file_name
		&& strcmp(mod->source_file_name, "-"))
			safe_printf("from in %s", mod->source_file_name);
		safe_printf("\n\n");

		safe_printf("syntax = \"proto3\";\n\n");
		safe_printf("package e2ctypes;\n\n");
